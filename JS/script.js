function iniciar() {
    ...
    if (usuarioGuardado) {
        ...
        if (usuario.password === password) {
            ...
            window.location.href = "../RegistrosWithJavaScript/registros.html"; // Cambia esto por la página que desees
        } else {
...
window.onload = function() {
    ...
    if (usuarioLogueado) {
        ...
        window.location.href = "../RegistrosWithJavaScript/registros.html"; // Cambiar a la página deseada
    }
};
